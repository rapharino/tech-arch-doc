...
![HashMap_base](_images/collection/HashMap_base.png)
...
![HashMap_getEntry](_images/collection/HashMap_getEntry.png)
...
![HashMap_addEntry](_images/collection/HashMap_addEntry.png)
```Java
//addEntry()
...
![HashMap_removeEntryForKey](_images/collection/HashMap_removeEntryForKey.png)
```Java
//removeEntryForKey()
